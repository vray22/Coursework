...
public class BTNode<E>
{
   ...
   **/ 
   ...
   /**
    * no parameters 
    * will print all leaves from tree with method that activated as root 
    * recursive method base case is if left and right is null 
    * will print data from node followed by line 
    * 
    * 
    */
   
   public void printLeaves(){
	   if(this.getLeft() == null && this.getRight() == null){//base case 
		   System.out.print(this.getData() + " ");
	   }
	   else if(this.getLeft() != null && this.getRight() != null){//if both right and left arent null make recursive call for left and right 
		   left.printLeaves();
		   right.printLeaves();
	  }
	   else if(this.getLeft() != null && this.getRight() == null){//make recursive call with left node 
		   left.printLeaves();
	   }
	   else if(this.getLeft() == null && this.getRight() != null){//make recursive call with right node 
		   right.printLeaves();
	   }
