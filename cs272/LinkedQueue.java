...
public class LinkedQueue<E> implements Cloneable
{
   ...
   **/ 
   ...
   /**
    * Get front element from que without removing it 
    * @param- none 
    * @precondition - que is not empty 
    * @return: the front of the que 
    * @exception: NoSuchElementException indicates queue is empty 
    **/
   public E peek(){
	   if(front == null){
   ...
   /**
    * will update the front of the que with item 
    *
    * @param item
    * @precondition: has to be a front item 
    * @postcondition: will update que with item 
    * @exception : NoSuchElementException no front element 
    */
   public void updateFront(E item){
	   if(front == null){
		   throw new NoSuchElementException("No front item");
	   }
	   else{
		   front.setData(item);
	   }
